...
// (default "version"); chain [JSONRegistry.WithVersionKey] to override.
...
// returns version 0 with an empty map, matching the semantics of a fresh
// (yet-to-be-written) file. encoding/json decodes numbers into float64.
